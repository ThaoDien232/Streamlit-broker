...
METRIC_TO_DB_KEYCODE = {
    ...
    'MARGIN_BALANCE': 'Margin_Lending_book',  # Note: different name in DB
    ...
    # Ratios - These might NOT exist in database, need to calculate
    'ROE': None,  # Calculate: NPAT / TOTAL_EQUITY * 100
    'ROA': None,  # Calculate: NPAT / TOTAL_ASSETS * 100
